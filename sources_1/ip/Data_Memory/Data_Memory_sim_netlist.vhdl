...
--               lab/MIPS_CPU_pipeline/MIPS_CPU_pipeline.srcs/sources_1/ip/Data_Memory/Data_Memory_sim_netlist.vhdl}
-- Design      : Data_Memory
...
ram_reg_0_127_0_0: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000209BD272708B02816DF68C560"
    )
        port map (
...
ram_reg_0_127_1_1: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"00000004EE21B164B6C844B2CE1E4729"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(1),
...
ram_reg_0_127_2_2: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000A04BAE092E043DC390AB43CCA"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(2),
...
ram_reg_0_127_3_3: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"00000004E058E930FAC21953E278B87F"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(3),
...
ram_reg_0_127_4_4: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000039262753D2058E1F21E875DCD"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(4),
...
ram_reg_0_127_5_5: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000892F6214432954619C6A027F6"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(5),
...
ram_reg_0_127_6_6: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000CE7DF715B885AE25C1BDF14A5"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(6),
...
ram_reg_0_127_7_7: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"00000000F34CA0712D6617EF72526BD2"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(7),
...
ram_reg_0_127_8_8: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000D9D465F4C14AB1D41E5A51E54"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(8),
...
ram_reg_0_127_9_9: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000D13B75A56CD1E41C7FC48449A"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(9),
...
entity Data_Memory_dist_mem_gen_v8_0_12 is
  ...
  attribute C_FAMILY of Data_Memory_dist_mem_gen_v8_0_12 : entity is "artix7";
  ...
  attribute C_HAS_DPO of Data_Memory_dist_mem_gen_v8_0_12 : entity is 1;
  attribute C_HAS_DPRA : integer;
  attribute C_HAS_DPRA of Data_Memory_dist_mem_gen_v8_0_12 : entity is 1;
  ...
  attribute C_MEM_INIT_FILE of Data_Memory_dist_mem_gen_v8_0_12 : entity is "Data_Memory.mif";
  attribute C_MEM_TYPE : integer;
  attribute C_MEM_TYPE of Data_Memory_dist_mem_gen_v8_0_12 : entity is 2;
  ...
  attribute C_READ_MIF of Data_Memory_dist_mem_gen_v8_0_12 : entity is 1;
  ...
  attribute C_WIDTH of Data_Memory_dist_mem_gen_v8_0_12 : entity is 32;
  attribute ORIG_REF_NAME : string;
...
entity Data_Memory is
  ...
  attribute x_core_info of Data_Memory : entity is "dist_mem_gen_v8_0_12,Vivado 2018.2";
end Data_Memory;
