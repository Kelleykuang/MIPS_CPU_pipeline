...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets load_in_IBUF];
##Switches
...
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { load_in }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=sw[14]
...
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { complete }]; #IO_L10P_T1_D14_14 Sch=led16_g
